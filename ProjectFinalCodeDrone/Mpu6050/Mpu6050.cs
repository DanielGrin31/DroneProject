...
namespace Iot.Device.Imu
{
    ...
    public class Mpu6050 : IDisposable
    {
        ...
        private byte XA_OFFSET_H;
        private byte XA_OFFSET_L;
        private byte YA_OFFSET_H;
        private byte YA_OFFSET_L;
        private byte ZA_OFFSET_H;
        private byte ZA_OFFSET_L;
        ...
        public Mpu6050(I2cDevice i2cDevice)
        {
            ...
            if (!CheckVersion())
            {
                throw new IOException($"This device does not contain the correct signature 0x68 for a MPU600");
            }
        ...
        public (Vector3 GyroscopeBias, Vector3 AccelerometerBias) CalibrateGyroscopeAccelerometer()
        {
            ...
            XA_OFFSET_H = rawData[0];
            XA_OFFSET_L = rawData[1];
            YA_OFFSET_H = rawData[2];
            YA_OFFSET_L = rawData[3];
            ZA_OFFSET_H = rawData[4];
            ZA_OFFSET_L = rawData[5];
